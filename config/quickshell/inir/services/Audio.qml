...
Singleton {
    ...
    Connections { // Protection against sudden volume changes
        ...
        function onVolumeChanged() {
            ...
            } else if (newVolume > maxAllowed + 1e-6 || newVolume > root.hardMaxValue) {
                // Clamp to the cap rather than snapping back, so the cap itself is
                // reachable despite floating-point overshoot from 2% steps
                // (1.48 + 0.02 = 1.5000000000000002, just over 1.5).
